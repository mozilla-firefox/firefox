...
void ReportDeprecation(nsIGlobalObject* aGlobal, Document* aDoc, nsIURI* aURI,
  ...
  body.mId.Construct(type.get());
  body.mMessage.Construct(msg.get());
  body.mSourceFile.Construct(NS_ConvertUTF8toUTF16(aFileName).get());
  body.mLineNumber.Construct(aLineNumber.Value());
  body.mColumnNumber.Construct(aColumnNumber.Value());
