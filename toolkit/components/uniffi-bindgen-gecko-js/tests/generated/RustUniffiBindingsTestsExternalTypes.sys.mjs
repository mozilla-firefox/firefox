...
const result = UniFFIScaffolding.callSync(
    273, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_interface
...
const result = UniFFIScaffolding.callSync(
    274, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_record
