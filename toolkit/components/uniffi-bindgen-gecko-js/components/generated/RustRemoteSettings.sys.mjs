...
export class RemoteSettings extends RemoteSettingsInterface {
    ...
    static init(
        ...
        const result = UniFFIScaffolding.callSync(
            83, // uniffi_remote_settings_fn_constructor_remotesettings_new
    ...
    async getRecordsSince(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            86, // uniffi_remote_settings_fn_method_remotesettings_get_records_since
            FfiConverterTypeRemoteSettings.lowerReceiver(this),
...
export class RemoteSettingsClient extends RemoteSettingsClientInterface {
    ...
    async collectionName() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            87, // uniffi_remote_settings_fn_method_remotesettingsclient_collection_name
    ...
    async getAttachment(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            88, // uniffi_remote_settings_fn_method_remotesettingsclient_get_attachment
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
    ...
    async getRecordsMap(
        ...
        FfiConverterBoolean.checkType(syncIfEmpty);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            90, // uniffi_remote_settings_fn_method_remotesettingsclient_get_records_map
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
            FfiConverterBoolean.lower(syncIfEmpty),
        )
        return handleRustResult(
    ...
    async shutdown() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            91, // uniffi_remote_settings_fn_method_remotesettingsclient_shutdown
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
        )
        return handleRustResult(
            result,
...
export class RemoteSettingsService extends RemoteSettingsServiceInterface {
    ...
    static init(
        ...
        const result = UniFFIScaffolding.callSync(
            93, // uniffi_remote_settings_fn_constructor_remotesettingsservice_new
    ...
    clientUrl() {
        ...
        const result = UniFFIScaffolding.callSync(
            94, // uniffi_remote_settings_fn_method_remotesettingsservice_client_url
    ...
    async sync() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            96, // uniffi_remote_settings_fn_method_remotesettingsservice_sync
            FfiConverterTypeRemoteSettingsService.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    updateConfig(
        ...
        FfiConverterTypeRemoteSettingsConfig2.checkType(config);
        const result = UniFFIScaffolding.callSync(
            97, // uniffi_remote_settings_fn_method_remotesettingsservice_update_config
            FfiConverterTypeRemoteSettingsService.lowerReceiver(this),
            FfiConverterTypeRemoteSettingsConfig2.lower(config),
        )
        return handleRustResult(
