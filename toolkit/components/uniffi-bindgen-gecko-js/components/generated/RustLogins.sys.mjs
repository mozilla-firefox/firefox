...
const result = UniFFIScaffolding.callSync(
    22, // uniffi_logins_fn_func_check_canary
...
FfiConverterString.checkType(encryptionKey);
const result = UniFFIScaffolding.callSync(
    23, // uniffi_logins_fn_func_create_canary
    FfiConverterString.lower(text),
    FfiConverterString.lower(encryptionKey),
)
return handleRustResult(
...
const result = UniFFIScaffolding.callSync(
    24, // uniffi_logins_fn_func_create_key
)
return handleRustResult(
    result,
    FfiConverterString.lift.bind(FfiConverterString),
...
const result = UniFFIScaffolding.callSync(
    25, // uniffi_logins_fn_func_create_login_store_with_nss_keymanager
...
const result = UniFFIScaffolding.callSync(
    26, // uniffi_logins_fn_func_create_login_store_with_static_key_manager
    FfiConverterString.lower(path),
...
const result = UniFFIScaffolding.callSync(
    27, // uniffi_logins_fn_func_create_managed_encdec
...
FfiConverterString.checkType(key);
const result = UniFFIScaffolding.callSync(
    28, // uniffi_logins_fn_func_create_static_key_manager
    FfiConverterString.lower(key),
)
return handleRustResult(
    result,
...
export class KeyManagerImpl extends KeyManager {
    ...
    getKey() {
        ...
        const result = UniFFIScaffolding.callSync(
            31, // uniffi_logins_fn_method_keymanager_get_key
...
export class LoginStore extends LoginStoreInterface {
    ...
    static init(
        ...
        const result = UniFFIScaffolding.callSync(
            32, // uniffi_logins_fn_constructor_loginstore_new
            FfiConverterString.lower(path),
    ...
    add(
        ...
        const result = UniFFIScaffolding.callSync(
            33, // uniffi_logins_fn_method_loginstore_add
    ...
    addMany(
        ...
        const result = UniFFIScaffolding.callSync(
            34, // uniffi_logins_fn_method_loginstore_add_many
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    addManyWithMeta(
        ...
        const result = UniFFIScaffolding.callSync(
            35, // uniffi_logins_fn_method_loginstore_add_many_with_meta
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    addWithMeta(
        ...
        const result = UniFFIScaffolding.callSync(
            37, // uniffi_logins_fn_method_loginstore_add_with_meta
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    count() {
        ...
        const result = UniFFIScaffolding.callSync(
            38, // uniffi_logins_fn_method_loginstore_count
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    countByFormActionOrigin(
        ...
        const result = UniFFIScaffolding.callSync(
            39, // uniffi_logins_fn_method_loginstore_count_by_form_action_origin
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    countByOrigin(
        ...
        FfiConverterString.checkType(origin);
        const result = UniFFIScaffolding.callSync(
            40, // uniffi_logins_fn_method_loginstore_count_by_origin
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    deleteMany(
        ...
        const result = UniFFIScaffolding.callSync(
            42, // uniffi_logins_fn_method_loginstore_delete_many
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    deleteUndecryptableRecordsForRemoteReplacement() {
        ...
        const result = UniFFIScaffolding.callSync(
            43, // uniffi_logins_fn_method_loginstore_delete_undecryptable_records_for_remote_replacement
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    get(
        ...
        FfiConverterString.checkType(id);
        const result = UniFFIScaffolding.callSync(
            45, // uniffi_logins_fn_method_loginstore_get
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(id),
        )
        return handleRustResult(
    ...
    getCheckpoint() {
        ...
        const result = UniFFIScaffolding.callSync(
            47, // uniffi_logins_fn_method_loginstore_get_checkpoint
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    hasLoginsByBaseDomain(
        ...
        FfiConverterString.checkType(baseDomain);
        const result = UniFFIScaffolding.callSync(
            48, // uniffi_logins_fn_method_loginstore_has_logins_by_base_domain
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(baseDomain),
        )
        return handleRustResult(
    ...
    isBreachAlertDismissed(
        ...
        FfiConverterString.checkType(id);
        const result = UniFFIScaffolding.callSync(
            49, // uniffi_logins_fn_method_loginstore_is_breach_alert_dismissed
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(id),
        )
        return handleRustResult(
    ...
    isEmpty() {
        ...
        const result = UniFFIScaffolding.callSync(
            50, // uniffi_logins_fn_method_loginstore_is_empty
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    isPotentiallyBreached(
        ...
        FfiConverterString.checkType(id);
        const result = UniFFIScaffolding.callSync(
            51, // uniffi_logins_fn_method_loginstore_is_potentially_breached
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(id),
        )
        return handleRustResult(
    ...
    list() {
        ...
        const result = UniFFIScaffolding.callSync(
            52, // uniffi_logins_fn_method_loginstore_list
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    recordBreach(
        ...
        const result = UniFFIScaffolding.callSync(
            53, // uniffi_logins_fn_method_loginstore_record_breach
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(id),
    ...
    recordBreachAlertDismissal(
        ...
        FfiConverterString.checkType(id);
        const result = UniFFIScaffolding.callSync(
            54, // uniffi_logins_fn_method_loginstore_record_breach_alert_dismissal
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(id),
        )
        return handleRustResult(
    ...
    recordBreachAlertDismissalTime(
        ...
        FfiConverterInt64.checkType(timestamp);
        const result = UniFFIScaffolding.callSync(
            55, // uniffi_logins_fn_method_loginstore_record_breach_alert_dismissal_time
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(id),
            FfiConverterInt64.lower(timestamp),
        )
    ...
    reset() {
        ...
        const result = UniFFIScaffolding.callSync(
            57, // uniffi_logins_fn_method_loginstore_reset
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    resetAllBreaches() {
        ...
        const result = UniFFIScaffolding.callSync(
            58, // uniffi_logins_fn_method_loginstore_reset_all_breaches
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async runMaintenance() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            59, // uniffi_logins_fn_method_loginstore_run_maintenance
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    setCheckpoint(
        ...
        const result = UniFFIScaffolding.callSync(
            60, // uniffi_logins_fn_method_loginstore_set_checkpoint
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    touch(
        ...
        FfiConverterString.checkType(id);
        const result = UniFFIScaffolding.callSync(
            62, // uniffi_logins_fn_method_loginstore_touch
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(id),
        )
        return handleRustResult(
    ...
    update(
        ...
        FfiConverterTypeLoginEntry.checkType(login);
        const result = UniFFIScaffolding.callSync(
            63, // uniffi_logins_fn_method_loginstore_update
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(id),
            FfiConverterTypeLoginEntry.lower(login),
        )
    ...
    wipeLocal() {
        ...
        const result = UniFFIScaffolding.callSync(
            64, // uniffi_logins_fn_method_loginstore_wipe_local
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
...
export class ManagedEncryptorDecryptor extends ManagedEncryptorDecryptorInterface {
    ...
    static init(
        ...
        FfiConverterTypeKeyManager.checkType(keyManager);
        const result = UniFFIScaffolding.callSync(
            65, // uniffi_logins_fn_constructor_managedencryptordecryptor_new
            FfiConverterTypeKeyManager.lower(keyManager),
        )
        return handleRustResult(
            result,
...
export class PrimaryPasswordAuthenticatorImpl extends PrimaryPasswordAuthenticator {
    ...
    async getPrimaryPassword() {
        ...
        const result = await UniFFIScaffolding.callAsync(
            68, // uniffi_logins_fn_method_primarypasswordauthenticator_get_primary_password
    ...
    async onAuthenticationSuccess() {
        ...
        const result = await UniFFIScaffolding.callAsync(
            69, // uniffi_logins_fn_method_primarypasswordauthenticator_on_authentication_success
            FfiConverterTypePrimaryPasswordAuthenticator.lowerReceiver(this),
        )
        return handleRustResult(
            result,
...
export class StaticKeyManager extends StaticKeyManagerInterface {
    ...
    static init(
        ...
        FfiConverterString.checkType(key);
        const result = UniFFIScaffolding.callSync(
            71, // uniffi_logins_fn_constructor_statickeymanager_new
            FfiConverterString.lower(key),
        )
        return handleRustResult(
            result,
