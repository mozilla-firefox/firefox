...
import mozilla.components.lib.integrity.googleplay.CloudProjectNumber
...
suspend fun StandardIntegrityTokenProvider.request(requestHashProvider: RequestHashProvider) =
...
suspend fun StandardIntegrityManager.prepare(cloudProjectNumber: CloudProjectNumber) =
    suspendCoroutine { continuation ->
